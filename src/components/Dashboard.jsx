            ...
            <div className="container-fluid">
                ...
                <div className="col-lg-12">
                    ...
                    <div className="header">
                        <h2><strong><i className="zmdi zmdi-chart" /> Sales</strong> Report</h2>
                    ...
                    <div className="body mb-2">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div className="d-flex justify-content-between">
                                <div>
                                <h5>2,365</h5>
                                <span><i className="zmdi zmdi-balance" /> Revenue</span>
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div className="d-flex justify-content-between">
                                <div>                                
                                <h5>365</h5>
                                <span><i className="zmdi zmdi-turning-sign" /> Returns</span>
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div className="d-flex justify-content-between">
                                <div>
                                <h5>65</h5>
                                <span><i className="zmdi zmdi-alert-circle-o" /> Queries</span>
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div className="d-flex justify-content-between">
                                <div>                            
                                <h5>2,055</h5>
                                <span><i className="zmdi zmdi-print" /> Invoices</span>
                                </div>
                    ...
                    <div className="body">
                        <div id="chart-area-spline-sracked" className="c3_chart d_sales" />
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div className="body">
                        ...
                        <li className="dropdown">
                            <a href="javascript:void(0);" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i className="zmdi zmdi-menu" /> </a>
                        ...
                        <li><a href="javascript:void(0);"><i className="zmdi zmdi-dribbble" /></a></li>
                        <li><a href="javascript:void(0);"><i className="zmdi zmdi-behance" /></a></li>
                        <li><a href="javascript:void(0);"><i className="zmdi zmdi-pinterest" /></a></li>
                        </ul>
                    </div>
                    </div>
                </div>                
                <div className="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div className="body">
                        <div className="w_icon pink"><i className="zmdi zmdi-bug" /></div>
                    ...
                    <div className="card w_data_1">
                    <div className="body">
                        <div className="w_icon cyan"><i className="zmdi zmdi-ticket-star" /></div>
                ...
                <div className="col-md-12 col-lg-8">
                    ...
                    <div className="body">
                        <div id="world-map-markers" className="jvector-map" />                            
                    </div>
                    </div>
                </div>
                <div className="col-lg-4 col-md-12">
                    ...
                    <div className="body text-center">
                        <div id="chart-pie" className="c3_chart d_distribution" />
                ...
                <div className="col-lg-12">
                    ...
                    <div className="body">
                        ...
                        <div className="col-lg-8 col-md-6 col-sm-12">
                            <div id="chart-area-step" className="c3_chart d_traffic" />
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <div className="flex-fill bd-highlight">
                                <h5 className="mb-0">21,521 <i className="zmdi zmdi-long-arrow-up" /></h5>
                                <small>Today</small>
                            </div>
                            <div className="flex-fill bd-highlight">
                                <h5 className="mb-0">%12.35 <i className="zmdi zmdi-long-arrow-down" /></h5>
